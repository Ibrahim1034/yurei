                    ...
                    <div class="auth-card p-4 p-md-5 p-lg-5">
                        ...
                        <form method="POST" action="{{ route('login') }}">
                            ...
                            <div class="mb-4 form-check">
                                ...
                                <label class="form-check-label fs-5" for="remember_me">Remember me</label>
                            </div>
                            ...
                            <div class="d-grid gap-2">
                                ...
                                @if (Route::has('password.request'))
                                    <a class="btn btn-link text-decoration-none mt-3 fs-5" href="{{ route('password.request') }}">
                        ...
                        <div class="text-center mt-5 pt-3">
                            <p class="mb-0 fs-5">Don't have an account? 
